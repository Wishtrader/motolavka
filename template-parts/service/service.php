...
$cards = [
    [
        'img' => get_field('service-card1_icon'),
        'title' => get_field('service-card1_heading'),
        'description' => get_field('service-card1_description'),
    ],
    [
        'img' => get_field('service-card2_icon'),
        'title' => get_field('service-card2_heading'),
        'description' => get_field('service-card2_description'),
    ],
    [
        'img' => get_field('service-card3_icon'),
        'title' => get_field('service-card3_heading'),
        'description' => get_field('service-card3_description'),
    ],
    [
        'img' => get_field('service-card4_icon'),
        'title' => get_field('service-card4_heading'),
        'description' => get_field('service-card4_description'),
    ],
];
?>
      ...
      <?php foreach ($cards as $card):
        ...
        <div
          class="transform transition duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] will-change-transform
                bg-[#2A3038] text-white flex flex-col p-2.5 lg:py-10 lg:px-[22px]
              ...
              ">
          <img src="<?= $img ?>" alt="<?= $title ?>" class="mb-[30px] h-[46px] lg:h-[72px] mr-auto" loading="lazy">
