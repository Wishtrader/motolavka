<section id="popular-cat" class="w-fullform py-10 mb-10 px-[10px] md:px-0">
  <div class="flex flex-col max-w-[1200px] mx-auto gap-[20px]">
    ...
    <div class="flex w-full flex-col gap-[20px]">
      ...
      <p class="text-sm font-normal text-white">Через сайт, заявку или напрямую.</p>
    </div>
      ...
      <div class="flex w-full flex-1 flex-col gap-[20px]">
        ...
        <div class="border-b-[#D95F0E]/50 border-b-[0.15px] w-full max-w-[193px]"></div>
        <p class="text-sm font-normal text-white">Помогаем понять, какая техника или запчасть подойдет именно вам.</p>
      </div>
      ...
      <div class="flex w-full flex-1 flex-col gap-[20px]">
        ...
        <p class="text-lg font-semibold text-white">Подбираем вариант</p>
        <div class="border-b-[#D95F0E]/50 border-b-[0.15px] w-full max-w-[193px]"></div>
        <p class="text-sm font-normal text-white">Учитываем категорию, параметры, наличие и совместимость.</p>
      </div>

      <div class="flex w-full flex-1 flex-col gap-[20px]">
        <h1 class="text-[52px] text-[#D95F0E]/30 font-bold mr-4">04</h1>
        <p class="text-lg font-semibold text-white">Согласовываем получение</p>
        <div class="border-b-[#D95F0E]/50 border-b-[0.15px] w-full max-w-[193px]"></div>
        <p class="text-sm font-normal text-white">Подтверждаем детали заказа и удобный способ получения.</p>
      </div>
