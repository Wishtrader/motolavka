...
<section class="w-full py-10 md:py-14 px-[10px] md:px-0 border-t border-[#2A3038]">
	<div class="max-w-[1200px] mx-auto">
		<h2 class="text-white text-[24px] md:text-[32px] font-bold mb-8 md:mb-10">Рекомендуем также</h2>
